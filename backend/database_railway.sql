...
-- This script creates tables in the database specified by MYSQLDATABASE environment variable
-- DO NOT create or use a specific database - Railway handles that
